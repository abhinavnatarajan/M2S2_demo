...
def discard_feature(dgm: str, dim: int, statistic: str, cell_group: tuple[str, ...]) -> bool:
    ...
    return (
        ...
        or (
            dim == 0  # dimension 0
            and dgm in ("dom", "im")
            and statistic.split("_")[0] in ("birth", "midpt", "length")
    ...
    *,
    ...
    if use_pca:
        data_raw = classification_preprocess(
            data, pca_size_ratio, min_features_retain, imputer_params,
        )
    else:
...
if __name__ == "__main__":
    ...
    default_options = {
        ...
        "output-file": {
            "type": str,
            "nargs": "?",
            "default": "dowker_comparison/results/eec_prediction_results.json",
        ...
        "logfile-dir": {
            "default": "dowker_comparison/logs",
            "type": str,
