...
def classification_preprocess(
    ...
    *,
    ...
    discard_epithelium: bool,
) -> tuple[pd.DataFrame, float]:
    """Preprocess the data from a single patient for classification.

    First epithelium data is dropped if discard_epithelium is true.
...
def run_classification_single_patient(
    ...
    *,
    ...
    data, avg_perc_features = classification_preprocess(
        ...
        discard_epithelium=discard_epithelium,
    )
...
def _init_logging(args: argparse.Namespace) -> logging.Logger:
    ...
    logfile = args.logfile_path.joinpath(
        "classification_by_patient_trichromatic_{}.log".format(
...
if __name__ == "__main__":
    ...
    default_options = {
        "stats-dirs": {
            ...
            "required": True,
            "nargs": "+",
            "help": "List of absolute or relative paths to the cell pair statistics.",
        },
        "output-file": {
            "type": str,
            "required": True,
        ...
        "discard-epithelium": {
            "action": "store_true",
            "help": "Whether to discard epithelium in the classification.",
        },
        "num-workers": {
            "default": 0,
            "type": int,
        ...
        "logfile-dir": {
            "default": "adenoma_carcinoma_pipeline/logs",
            "type": str,
    ...
    classification_results = run_classification_all_patients(
        ...
        labels_include=labels_include,
        labels_exclude=labels_exclude,
        discard_epithelium=args.discard_epithlium,
